...
VERIFIED_BW11_CHECKLIST_FINISHES = {
    "bw11-1": {"localId": "1", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-106": {"localId": "106", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-113": {"localId": "113", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-18": {"localId": "18", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-25": {"localId": "25", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-32": {"localId": "32", "finishes": ["Holo", "Reverse Holo"]},
    "bw11-4": {"localId": "4", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-47": {"localId": "47", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-54": {"localId": "54", "finishes": ["Holo"]},
    "bw11-62": {"localId": "62", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-7": {"localId": "7", "finishes": ["Normal", "Reverse Holo"]},
    "bw11-77": {"localId": "77", "finishes": ["Holo"]},
    "bw11-84": {"localId": "84", "finishes": ["Holo", "Reverse Holo"]},
    "bw11-91": {"localId": "91", "finishes": ["Holo", "Reverse Holo"]},
    "bw11-99": {"localId": "99", "finishes": ["Holo", "Reverse Holo"]},
    "bw11-RC17": {"localId": "RC17", "finishes": ["Normal"]},
    "bw11-RC9": {"localId": "RC9", "finishes": ["Normal"]},
}
BW11_OFFICIAL_CHECKLIST_SOURCE = "https://assets.pokemon.com/assets/cms2/pdf/trading-card-game/checklist/bw11_web_cardlist_en.pdf"
...
VERIFIED_SM1_CHECKLIST_FINISHES = {
    "sm1-1": {"localId": "1", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-108": {"localId": "108", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-117": {"localId": "117", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-126": {"localId": "126", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-135": {"localId": "135", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-144": {"localId": "144", "finishes": ["Holo"]},
    "sm1-26": {"localId": "26", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-44": {"localId": "44", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-53": {"localId": "53", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-62": {"localId": "62", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-71": {"localId": "71", "finishes": ["Holo", "Reverse Holo"]},
    "sm1-9": {"localId": "9", "finishes": ["Normal", "Reverse Holo"]},
    "sm1-99": {"localId": "99", "finishes": ["Holo", "Reverse Holo"]},
}
SM1_OFFICIAL_CHECKLIST_SOURCE = "https://assets.pokemon.com/assets/cms2/pdf/trading-card-game/checklist/sm1_web_cardlist_en.pdf"

VERIFIED_SM12_CHECKLIST_FINISHES = {
    "sm12-113": {"localId": "113", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-128": {"localId": "128", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-142": {"localId": "142", "finishes": ["Holo", "Reverse Holo"]},
    "sm12-170": {"localId": "170", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-185": {"localId": "185", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-2": {"localId": "2", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-213": {"localId": "213", "finishes": ["Holo"]},
    "sm12-228": {"localId": "228", "finishes": ["Holo"]},
    "sm12-40": {"localId": "40", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-55": {"localId": "55", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-7": {"localId": "7", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-84": {"localId": "84", "finishes": ["Normal", "Reverse Holo"]},
    "sm12-99": {"localId": "99", "finishes": ["Normal", "Reverse Holo"]},
}
...
VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES = {
    "sm1-153": {"setId": "sm1", "localId": "153", "finishes": ["Holo"],
                "evidence": "https://pokedreams.com/tcg/cards/sm1-153"},
    "sm1-162": {"setId": "sm1", "localId": "162", "finishes": ["Holo"],
                "evidence": "https://www.mydextcg.com/cards/sm1-162"},
    "sm1-171": {"setId": "sm1", "localId": "171", "finishes": ["Normal", "Reverse Holo"],
                "evidence": "https://www.pokescreener.com/set/sm1/card/171?source=set_detail"},
    "sm12-242": {"setId": "sm12", "localId": "242", "finishes": ["Holo"],
                 "evidence": "https://evoterminal.com/card/201353"},
    "sm12-257": {"setId": "sm12", "localId": "257", "finishes": ["Holo"],
                 "evidence": "https://pokedreams.com/tcg/cards/sm12-257"},
    "sm12-271": {"setId": "sm12", "localId": "271", "finishes": ["Holo"],
                 "evidence": "https://pokedreams.com/tcg/cards/sm12-271"},
}
...
def run_ditto_production_runtime(source):
    names = (
        ...
        "isBallReverseVariant", "isPatternReverseVariant", "isAscendedNamedPatternReverseVariant",
...
def verified_bw11_checklist_truth(card):
    """Exact Legendary Treasures identities verified against the official Pokemon checklist."""
    cid = str(card.get("id") or card.get("tcgdexId") or "")
    rule = VERIFIED_BW11_CHECKLIST_FINISHES.get(cid)
    if not rule:
        return set()
    if str((card.get("set") or {}).get("id") or "").lower() != "bw11":
        return set()
...
def verified_sm1_checklist_truth(card):
    """Exact Sun & Moon base-set identities verified against the official Pokemon checklist."""
    cid = str(card.get("id") or card.get("tcgdexId") or "")
    rule = VERIFIED_SM1_CHECKLIST_FINISHES.get(cid)
    if not rule:
        return set()
    if str((card.get("set") or {}).get("id") or "").lower() != "sm1":
        return set()
    if str(card.get("localId") or "").lstrip("0") != str(rule["localId"]).lstrip("0"):
        return set()
    return set(rule["finishes"])
...
def verified_sm12_checklist_truth(card):
    """Exact Cosmic Eclipse identities verified against the official Pokemon checklist."""
    cid = str(card.get("id") or card.get("tcgdexId") or "")
    rule = VERIFIED_SM12_CHECKLIST_FINISHES.get(cid)
    if not rule:
        return set()
    if str((card.get("set") or {}).get("id") or "").lower() != "sm12":
        return set()
    if str(card.get("localId") or "").lstrip("0") != str(rule["localId"]).lstrip("0"):
        return set()
    return set(rule["finishes"])
...
def verified_extra_numbered_marketplace_truth(card):
    """Exact historical extra-numbered identities with explicit printing evidence."""
    cid = str(card.get("id") or card.get("tcgdexId") or "")
    rule = VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.get(cid)
    if not rule:
        return set()
...
def verified_stamped_identity_truth(card, mep_registry=None, mfb_registry=None, worlds_registry=None):
    ...
    swshp_25th = {
        ...
        "swshp-SWSH143": 576742,
        "swshp-SWSH144": 576743,
        "swshp-SWSH145": 576744,
        "swshp-SWSH146": 576745,
    }
    if card_id in swshp_25th:
        exact = [
            ...
            and not row.get("foil")
            and str(row.get("size") or "standard").lower() != "jumbo"
            and int(((row.get("thirdParty") or {}).get("cardmarket")) or 0) == swshp_25th[card_id]
        ]
        return {"Holo"} if len(exact) == 1 else set()

    swshp_set_logo = {
        "swshp-SWSH168": 580165,
        "swshp-SWSH169": 580166,
        "swshp-SWSH170": 580167,
        "swshp-SWSH171": 580168,
    }
...
def verified_hidden_fates_shiny_vault_truth(card, audit_id=None):
    """Official Hidden Fates checklist marks every SV1-SV94 Shiny Vault card as Shiny Vault foil."""
    cid=str(audit_id or card.get("id") or card.get("tcgdexId") or "").strip().lower()
    set_id=str((card.get("set") or {}).get("id") or "").strip().lower()
...
def main():
    ...
    expected_normal_registry.update({
        card_id: {"setId": "sm1", "localId": row["localId"]}
        for card_id, row in VERIFIED_SM1_CHECKLIST_FINISHES.items()
        if "Normal" in row["finishes"]
    })
    expected_normal_registry.update({
    ...
    expected_normal_registry.update({
        card_id.lower(): {"setId": row["setId"], "localId": row["localId"]}
        for card_id, row in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items()
        if "Normal" in row["finishes"]
    })
    ...
    if registries["holo"] != expected_holo_registry:
        raise AssertionError("VERIFIED_HOLO_FINISHES differs from the exact audited identity set")
    ...
    for cid in sample_ids:
        ...
        bw11_checklist_truth = verified_bw11_checklist_truth(en)
        if bw11_checklist_truth:
            truth.update(bw11_checklist_truth)
            it_truth.update(bw11_checklist_truth)
        ...
        sm1_checklist_truth = verified_sm1_checklist_truth(en)
        if sm1_checklist_truth:
            truth.update(sm1_checklist_truth)
            it_truth.update(sm1_checklist_truth)
        sm12_checklist_truth = verified_sm12_checklist_truth(en)
        ...
        extra_numbered_marketplace_truth = verified_extra_numbered_marketplace_truth(en)
        if extra_numbered_marketplace_truth:
            truth.update(extra_numbered_marketplace_truth)
            it_truth.update(extra_numbered_marketplace_truth)
    ...
    sm1_normal_ids = {k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Normal" in v["finishes"]}
    sm1_holo_ids = {k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Holo" in v["finishes"]}
    sm1_reverse_ids = {k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Reverse Holo" in v["finishes"]}
    ...
    extra_normal_ids = {k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Normal" in v["finishes"]}
    extra_holo_ids = {k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Holo" in v["finishes"]}
    extra_reverse_ids = {k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Reverse Holo" in v["finishes"]}
    expected_normal_applied = set(VERIFIED_NORMAL_TARGETS) | bw1_normal_ids | bw11_normal_ids | xy1_normal_ids | sm1_normal_ids | sm12_normal_ids | generations_normal_ids | extra_normal_ids
    ...
    expected_holo_checklist_ids = bw11_holo_ids | xy1_holo_ids | sm1_holo_ids | sm12_holo_ids | generations_holo_ids | extra_holo_ids
    ...
    expected_reverse_checklist_ids = bw1_reverse_ids | bw11_reverse_ids | xy1_reverse_ids | sm1_reverse_ids | sm12_reverse_ids | generations_reverse_ids | extra_reverse_ids
    ...
    report = {
        ...
        "verifiedBw11ChecklistFinishAudit": {
            "expectedIdentities": len(VERIFIED_BW11_CHECKLIST_FINISHES),
            "normalIdentities": sorted(k for k,v in VERIFIED_BW11_CHECKLIST_FINISHES.items() if "Normal" in v["finishes"]),
            "holoIdentities": sorted(k for k,v in VERIFIED_BW11_CHECKLIST_FINISHES.items() if "Holo" in v["finishes"]),
            "reverseIdentities": sorted(k for k,v in VERIFIED_BW11_CHECKLIST_FINISHES.items() if "Reverse Holo" in v["finishes"]),
            "officialChecklist": BW11_OFFICIAL_CHECKLIST_SOURCE,
            "productionRegistryExact": True,
            "outsideListInheritedRule": False,
            "unstampedOnly": True,
            "priceFieldsPresent": False,
            "assessment": "Exact Legendary Treasures identities only; no set-wide rarity or era rule introduced.",
        },
        "verifiedXy1ChecklistFinishAudit": {
            "expectedIdentities": len(VERIFIED_XY1_CHECKLIST_FINISHES),
            "normalIdentities": sorted(k for k,v in VERIFIED_XY1_CHECKLIST_FINISHES.items() if "Normal" in v["finishes"]),
            "holoIdentities": sorted(k for k,v in VERIFIED_XY1_CHECKLIST_FINISHES.items() if "Holo" in v["finishes"]),
            "reverseIdentities": sorted(k for k,v in VERIFIED_XY1_CHECKLIST_FINISHES.items() if "Reverse Holo" in v["finishes"]),
        ...
        "verifiedSm1ChecklistFinishAudit": {
            "expectedIdentities": len(VERIFIED_SM1_CHECKLIST_FINISHES),
            "normalIdentities": sorted(k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Normal" in v["finishes"]),
            "holoIdentities": sorted(k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Holo" in v["finishes"]),
            "reverseIdentities": sorted(k for k,v in VERIFIED_SM1_CHECKLIST_FINISHES.items() if "Reverse Holo" in v["finishes"]),
            "officialChecklist": SM1_OFFICIAL_CHECKLIST_SOURCE,
            "productionRegistryExact": True,
            "outsideListInheritedRule": False,
            "unstampedOnly": True,
            "priceFieldsPresent": False,
            "excludedResidualIds": ["sm1-153","sm1-162","sm1-171"],
            "assessment": "Only exact Sun & Moon identities visibly covered by the standard checklist; secret/extra residuals remain ambiguous.",
        },
        "verifiedSm12ChecklistFinishAudit": {
            "expectedIdentities": len(VERIFIED_SM12_CHECKLIST_FINISHES),
            "normalIdentities": sorted(k for k,v in VERIFIED_SM12_CHECKLIST_FINISHES.items() if "Normal" in v["finishes"]),
            "holoIdentities": sorted(k for k,v in VERIFIED_SM12_CHECKLIST_FINISHES.items() if "Holo" in v["finishes"]),
            "reverseIdentities": sorted(k for k,v in VERIFIED_SM12_CHECKLIST_FINISHES.items() if "Reverse Holo" in v["finishes"]),
            "officialChecklist": SM12_OFFICIAL_CHECKLIST_SOURCE,
            "productionRegistryExact": True,
            "outsideListInheritedRule": False,
            "unstampedOnly": True,
            "priceFieldsPresent": False,
        ...
        "verifiedExtraNumberedMarketplaceFinishAudit": {
            "expectedIdentities": len(VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES),
            "normalIdentities": sorted(k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Normal" in v["finishes"]),
            "holoIdentities": sorted(k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Holo" in v["finishes"]),
            "reverseIdentities": sorted(k for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items() if "Reverse Holo" in v["finishes"]),
            "evidence": {k:v["evidence"] for k,v in VERIFIED_EXTRA_NUMBERED_MARKETPLACE_FINISHES.items()},
            "productionRegistryExact": True,
            "outsideListInheritedRule": False,
            "unstampedOnly": True,
            "priceFieldsPresent": False,
            "excludedStampedResidualIds": ["mep-028","svp-225"],
            "assessment": "Six exact extra-numbered historical identities only; no rarity or set-wide rule introduced.",
        },
